...
这是一个云服务提供商，允许个人使用小规模免费的云服务

```embed
title: "Qdrant Cloud"
image: ""
description: "个人云服务集群"
url: "https://cloud.qdrant.io/accounts/9e104d35-a2e4-46a5-aba2-2d865e0b6f49/clusters/5ed7e057-3576-46ff-8779-c482c2ae0220/overview"
```

相应的 API key 和 Endpoint 如下

```
API-key: eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhY2Nlc3MiOiJtIiwic3ViamVjdCI6ImFwaS1rZXk6YjlmMTBkNGUtNDI2ZS00NDU4LTk3MzYtMTQ4OGZhNzk4MGY1In0.HU2UMi_ZaNRv1erePP2pVSeCCKdjPyeJbeX7JqBWn7k
Endpoint:
https://5ed7e057-3576-46ff-8779-c482c2ae0220.eu-west-2-0.aws.cloud.qdrant.io
```
...
- TDD 测试驱动开发：先写测试、再实现，关注代码正确性
- BDD 行为驱动开发：Given/When/Then，关注业务验收
- DDD 领域驱动开发：关注业务建模

而 Spec 导向的 SDD 规范驱动开发，要求先将需求、约束、边界条件、验收标准写成结构化的 Spec 文档，然后让 AI 基于 Spec 规划、拆解、编码、测试、反复校验。不同的开发模式覆盖了不同的层级
$$
DDD \to BDD \to SDD \to TDD
$$
并不是相互替代的关系。
